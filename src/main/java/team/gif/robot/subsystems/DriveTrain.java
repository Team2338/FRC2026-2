...
public class DriveTrain extends SubsystemBase {
    ...
    public DriveTrain() {
        rearLeftCIM = new WPI_TalonSRX(RobotMap.RL_CIM);
        rearRightCIM = new WPI_TalonSRX(RobotMap.RR_CIM);
        frontLeftCIM = new WPI_TalonSRX(RobotMap.FL_CIM);
        frontRightCIM = new WPI_TalonSRX(RobotMap.FR_CIM);
